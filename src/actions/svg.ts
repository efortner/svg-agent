...
export class Svg implements Action<'reasoning' | 'svg'> {
  private index: number = 0;

  name: string = 'svg';
  arguments: [ActionArgument<'reasoning'>, ActionArgument<'svg'>] = [
    {
      name: 'reasoning',
      description:
        'The reasoning behind what you are writing. This should describe the intended image as well as changes you are making from previous iterations.',
    },
    {
      name: 'svg',
  ...
  examples: {
    ...
    {
      arguments: [
        'I am attempting to create a vector graphic of the "times" symbol.',
        rawExampleSvg,
      ],
  ...
  apply = async (
    args: Record<'reasoning' | 'svg', string>,
  ): Promise<string> => {
